...
def Procesar_Archivo(opcion):
    ...
    if doc_f != "":
        ...
        validaciones_model, medidas_dxf_f,parcelas_poly_close_f,parcelas_poly,excedentes_poly, mejoras_dict,band_dict, nom_parc_list,manzana_poly  = chequeo_model(doc_f, nom_layers_dxf, colores)

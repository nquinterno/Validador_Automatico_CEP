...
def analisis_FOMUBI(pages_FOMUBI_text):
    ...
    sec_fomubi = re.findall(r'Sección:\s*(.*?)\s*', pages_FOMUBI_text)
    manz_fomubi = re.findall(r'Manzana:\s*(.*?)\s*', pages_FOMUBI_text)
    parc_fomubi_0 =  re.findall(r'Parcela:\s*(.*?)\s*', pages_FOMUBI_text)
    exp_fomubi_0 = re.findall(r'EX-(.*?)- -GCABA-DGROC', pages_FOMUBI_text)



    print(pages_FOMUBI_text)
    print("******************")
    print(sec_fomubi)
    print(manz_fomubi)
    print(parc_fomubi_0)

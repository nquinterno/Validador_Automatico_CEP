...
def rumbo(parcela, seg):
    ...
    if parcela.has_arc:
        ...
        for lado in lados:
            if lado.dxftype() == "ARC":
                ...
                print("arco_discretizado: ", arco_discretizado)
    ...
    if ezdxf.math.is_point_in_polygon_2d(Vec2(midpoint_seg1),vertices_p2,abs_tol=1e-3)==-1:
        if ezdxf.math.is_point_in_polygon_2d(Vec2(midpoint_seg2),vertices_p2,abs_tol=1e-3)==-1:
            print("entro en este error")
            print("midpoint_seg1: ", midpoint_seg1)
            print("midpoint_seg2: ", midpoint_seg2)
            print("vertices_p2: ", vertices_p2)
            pass
        else:

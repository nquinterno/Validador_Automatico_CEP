                    ...
                    if "-1" in band_tol_m4:
                        if "-1" in band_tol_m5:
                            if "-1" in band_tol_m6:
                                ...
                                validaciones2.loc[31,'Resultado']=-1 # si hay un -1 en la bandera arroja error 
                                validaciones2.loc[31,'Observacion']="Error: No se ha georreferenciado Correctamente"
                                validaciones2.loc[31,'Cetegoría']='Tolerancias'
                                ...
                                validaciones2.loc[31,'Resultado']=50 # si hay un -1 en la bandera arroja error 
                                validaciones2.loc[31,'Observacion']="Verificar: La parcela medida difiere en mas de 50cm de la manzana catastral"
                                validaciones2.loc[31,'Cetegoría']='Tolerancias'
                ...
                if "-1" in band_tol_p:
                    if "-1" in band_tol_p4:
                        if "-1" in band_tol_p5:
                            if "-1" in band_tol_p6:
                                validaciones2.loc[32,'Resultado']=-1 # si hay un -1 en la bandera arroja error 
                                validaciones2.loc[32,'Observacion']="Error: La parcela medida excede la tolerancia admitida respecto a la parcela antecedente o no se ha georreferenciado correctamente"
                                validaciones2.loc[32,'Cetegoría']='Tolerancias'
                            else:
                                validaciones2.loc[32,'Resultado']=50 # si hay un -1 en la bandera arroja error 
                                validaciones2.loc[32,'Observacion']="Verificar: La parcela medida excede la tolerancia admitida respecto a la parcela antecedente de Ciudad 3d"
                                validaciones2.loc[32,'Cetegoría']='Tolerancias'
                        else:
                            validaciones2.loc[32,'Resultado']=50 # si hay un -1 en la bandera arroja error 
                            validaciones2.loc[32,'Observacion']="Verificar: La parcela medida excede la tolerancia admitida respecto a la parcela antecedente de Ciudad 3d"
                        ...
                        validaciones2.loc[32,'Observacion']="Ok: La parcela se encuentra en tolerancia con respecto a la parcela antecedente de Ciudsd 3d"
                        validaciones2.loc[32,'Cetegoría']='Tolerancias'
                else:
    ...
    if len(pages_IFTAM_text)>0 and len(pages_IFFVN_text)>0 and len(pages_IFDOM_text)>0:
        ...
        if "cep_demolicion" in band_notas:
            if  cubierta_3 != 0:
                ...
                validaciones2.loc[51,'Observacion']="Error: Se declaró CEP Demolición y se declaró Superficie cubierta distinta de 0 en el form de Mensura'"
            else:
                validaciones2.loc[51,'Resultado']=0
                validaciones2.loc[51,'Observacion']="Ok: Se declaró CEP Demolición y se declaró Superficie cubierta igual a 0 en el form de Mensura'"

            if semi_3 !=0:
                validaciones2.loc[52,'Resultado']=-1
                validaciones2.loc[52,'Observacion']="Error: Se declaró CEP Demolición y se declaró Superficie semicubierta distinta de 0 en el form de Mensura'"
            else:
                validaciones2.loc[52,'Resultado']=0
                validaciones2.loc[52,'Observacion']="Ok: Se declaró CEP Demolición y se declaró Superficie semicubierta igual a 0 en el form de Mensura'"

            if des_3 !=0:
                validaciones2.loc[53,'Resultado']=-1
                validaciones2.loc[53,'Observacion']="Error: Se declaró CEP Demolición y se declaró Superficie descubierta distinta de 0 en el form de Mensura'"
            else:
                validaciones2.loc[53,'Resultado']=0
                validaciones2.loc[53,'Observacion']="Ok: Se declaró CEP Demolición y se declaró Superficie descubierta igual a 0 en el form de Mensura'"

            if plantas_3 !=0:
                validaciones2.loc[54,'Resultado']=-1
                validaciones2.loc[54,'Observacion']="Error: Se declaró CEP Demolición y se declaró cantidad de plantas edificadas distinta de 0 en el form de Mensura'"
            else:
                validaciones2.loc[54,'Resultado']=0
                validaciones2.loc[54,'Observacion']="Ok: Se declaró CEP Demolición y se declaró cantidad de plantas edificadas igual a 0 en el form de Mensura'"
        else:
            pass
...
def analisis_FOMUBI():
    ...
    global smp_fomubi
    global exp_fomubi
    smp_fomubi =  re.findall(r'Superficie en mts 2: (.*?)Descripción según título:', pages_FOMUBI_text)
    exp_fomubi = re.findall(r'Superficie en mts 2: (.*?)Descripción según título:', pages_FOMUBI_text)
...
def salida_pdf():
    ...
    if len(validaciones3)>0:
        ...
        c.rect(190,675,200,20,stroke=1,fill=1)
        ...
        c.rect(40,675,150,20,stroke=1,fill=0)
        c.rect(190,675,200,20,stroke=1,fill=0)
        c.rect(390,675,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 680, 'N°')
        c.drawString(200, 680, 'Valor Según DXF')
        c.drawString(400, 680, 'Valor Según Formulario de Mensura')

        
        c.rect(40,655,150,20,stroke=1,fill=0)
        c.rect(190,655,200,20,stroke=1,fill=0)
        c.rect(390,655,200,20,stroke=1,fill=0)        
        
        c.drawString(50, 660, 'Superficie Parcela')
        c.drawString(200, 660, f'{area_parc_dxf}')
        c.drawString(400, 660, f'{mensura_3}')

        
        c.rect(40,635,150,20,stroke=1,fill=0)
        c.rect(190,635,200,20,stroke=1,fill=0)
        c.rect(390,635,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 640, 'Superficie Excedente')
        c.drawString(200, 640, f'{area_excedente_dxf}')
        c.drawString(400, 640, f'-')

        
        c.rect(40,615,150,20,stroke=1,fill=0)
        c.rect(190,615,200,20,stroke=1,fill=0)
        c.rect(390,615,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 620, 'Cantidad de Plantas')
        c.drawString(200, 620, f'{plantas_dxf}')
        c.drawString(400, 620, f'{plantas_3}')

        
        c.rect(40,595,150,20,stroke=1,fill=0)
        c.rect(190,595,200,20,stroke=1,fill=0)
        c.rect(390,595,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 600, 'Superficie cubierta')
        c.drawString(200, 600, f'{cubierta_dxf}')
        c.drawString(400, 600, f'{cubierta_3}')

        
        c.rect(40,575,150,20,stroke=1,fill=0)
        c.rect(190,575,200,20,stroke=1,fill=0)
        c.rect(390,575,200,20,stroke=1,fill=0)  
        
        c.drawString(50, 580, 'Superficie Semicubierta')
        c.drawString(200, 580, f'{semicubierta_dxf}')
        c.drawString(400, 580, f'{semi_3}')

        
        c.rect(40,555,150,20,stroke=1,fill=0)
        c.rect(190,555,200,20,stroke=1,fill=0)
        c.rect(390,555,200,20,stroke=1,fill=0)  
        
        c.drawString(50, 560, 'Superficie Descubierta')
        c.drawString(200, 560, f'{descubierta_dxf}')
        c.drawString(400, 560, f'{des_3}')

        
        c.rect(40,535,150,20,stroke=1,fill=0)
        c.rect(190,535,200,20,stroke=1,fill=0)
        c.rect(390,535,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 540, 'Superficie en Contravención')
        c.drawString(200, 540, f'-')
        c.drawString(400, 540, f'{cont_3}')

        
        c.rect(40,515,150,20,stroke=1,fill=0)
        c.rect(190,515,200,20,stroke=1,fill=0)
        c.rect(390,515,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 520, 'Superficie Empadronada')
        c.drawString(200, 520, f'{sup_emp_dxf}')
        c.drawString(400, 520, f'-')

        
        c.rect(40,495,150,20,stroke=1,fill=0)
        c.rect(190,495,200,20,stroke=1,fill=0)
        c.rect(390,495,200,20,stroke=1,fill=0) 
        
        c.drawString(50, 500, 'Superficie a Empadronar')
        c.drawString(200, 500, f'{sup_nueva_dxf}')
        c.drawString(400, 500, f'-')

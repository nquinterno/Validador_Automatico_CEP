    ...
    if len(pages_IFTAM_text)>0 and len(pages_IFFVN_text)>0 and len(pages_IFDOM_text)>0:
        ...
        if dif_agip =="no":
            if ((nota_agip_nodif.lower().replace(" ","")).replace(".","") in (notas_0[0].lower())) or ((nota_cep_demolicion.lower().replace(" ","")).replace(".","") in (notas_0[0].lower())):
                ...
                validaciones2.loc[43,'Observacion']="Ok: se declaró que no difiere con agip y se detectó la nota segun los RT en notas del form. tecnico de mensura"
            else:
                validaciones2.loc[43,'Resultado']=-1
                validaciones2.loc[43,'Observacion']="Error: se declaró que no difiere con agip y no se detectó la nota segun los RT en notas del form. tecnico de mensura"
        elif dif_agip =="si":
            if len(agip_supnueva)>0:
                if (nota_agip_dif_mas.lower().replace(" ","")).replace(".","") in (notas_0[0].lower()):
                    validaciones2.loc[43,'Resultado']=0
                    validaciones2.loc[43,'Observacion']="Ok: se declaró que difiere con agip, superficie nueva y se detectó la nota segun los RT en notas del form. tecnico de mensura"
                else:
                    validaciones2.loc[43,'Resultado']=-1
                    validaciones2.loc[43,'Observacion']="Error: se declaró que difiere con agip, superficie nueva y no se detectó la nota segun los RT en notas del form. tecnico de mensura"
            else:
                if (nota_agip_dif_menos.lower().replace(" ","")).replace(".","") in (notas_0[0].lower()):
                    validaciones2.loc[43,'Resultado']=0
                    validaciones2.loc[43,'Observacion']="Ok: se declaró que difiere con agip, sin superficie nueva y se detectó la nota segun los RT en notas del form. tecnico de mensura"
                else:
                    validaciones2.loc[43,'Resultado']=-1
                    validaciones2.loc[43,'Observacion']="Error: se declaró que difiere con agip, sin superficie nueva y no se detectó nota según los RT en notas del form. técnico de mensura"        
        else:
            validaciones2.loc[43,'Resultado']=-1
        ...
        if "-1" in band_cur_parcela:
            validaciones2.loc[44,'Resultado']=-1
            validaciones2.loc[44,'Observacion']="Error: No se puede comprobar APH y afectaciones de la parcela por no poder conectarse con Ciudad 3d, verifique conexión de internet"
        else:
            if  (nota_cep_demolicion.lower().replace(" ","")).replace(".","") in (notas_0[0].lower()):
                if aph != "No":
                    validaciones2.loc[44,'Resultado']=-1
                    validaciones2.loc[44,'Observacion']="Error: Se ha declarado CEP Demolición y la parcela esta afectada a APH"

                else:
                    validaciones2.loc[44,'Resultado']=0
                    validaciones2.loc[44,'Observacion']="Ok: Se ha declarado CEP Demolición y la parcela no esta afectada a APH"

            else:
                validaciones2.loc[44,'Resultado']=0
                validaciones2.loc[44,'Observacion']="Ok: No se ha declarado CEP Demolición"


            if aph != "No":
                if  nota_aph.lower().replace(" ","") in (notas_0[0].lower()):
                    validaciones2.loc[45,'Resultado']=0
                    validaciones2.loc[45,'Observacion']="Ok: Se ha indicado la Nota de Aph en formulario de Mensura"
                else:
                    validaciones2.loc[45,'Resultado']=-1
                    validaciones2.loc[45,'Observacion']="Error: No se ha indicado la Nota de Aph en formulario de Mensura y la parcela se encuentra catalogada"
            else:
                validaciones2.loc[45,'Resultado']=99
                validaciones2.loc[45,'Observacion']="Ok: No corresponde validar nota de Aph"
            ...
            if "Cinturon Digital" in cur_afectaciones:
                if "Cinturon Digital" in particularidades:
                    if "Cinturon Digital".lower().replace(" ","") in (notas_0[0].lower()):
                        ...
                        validaciones2.loc[46,'Observacion']="Ok: Se indicó nota de 'Afectación a Cinturon Digital' en Notas del formulario de Mensura"
                    else:
                        validaciones2.loc[46,'Resultado']=-1
                        validaciones2.loc[46,'Observacion']="Error: No se indicó nota de 'Afectación a Cinturon Digital' en Notas del formulario de Mensura"
                else:
                    validaciones2.loc[46,'Resultado']=-1
                    validaciones2.loc[46,'Observacion']="Error: No se indicó nota de 'Afectación a Cinturon Digital' en Particularidades del formulario de Mensura"
            else:
                validaciones2.loc[46,'Resultado']=99
                validaciones2.loc[46,'Observacion']="Ok: No corresponde validar nota de 'Afectación Cinturon Digital'"
            ...
            if "Afectación por Apertura" in cur_afectaciones:
                if "Afectación por Apertura" in particularidades:
                    if "Afectación por Apertura".lower().replace(" ","") in (notas_0[0].lower()):
                        ...
                        validaciones2.loc[47,'Observacion']="Ok: Se indicó nota de 'Afectación por Apertura' en Notas del formulario de Mensura"
                    else:
                        validaciones2.loc[47,'Resultado']=-1
                        validaciones2.loc[47,'Observacion']="Error: No se indicó nota de 'Afectación por Apertura' en Notas del formulario de Mensura"
                else:
                    validaciones2.loc[47,'Resultado']=-1
                    validaciones2.loc[47,'Observacion']="Error: No se indicó nota de 'Afectación por Apertura' en Particularidades del formulario de Mensura"
            else:
                validaciones2.loc[47,'Resultado']=99
                validaciones2.loc[47,'Observacion']="Ok: No corresponde validar nota 'Afectación por Apertura'"
            ...
            if "Afectación por Ensanche" in cur_afectaciones:
                if "Afectación por Ensanche" in particularidades:
                    if "Afectación por Ensanche".lower().replace(" ","") in (notas_0[0].lower()):
                        ...
                        validaciones2.loc[48,'Observacion']="Ok: Se indicó nota de 'Afectación por Ensanche' en Notas del formulario de Mensura"
                    else:
                        validaciones2.loc[48,'Resultado']=-1
                        validaciones2.loc[48,'Observacion']="Error: No se indicó nota de 'Afectación por Ensanche' en Notas del formulario de Mensura"
                else:
                    validaciones2.loc[48,'Resultado']=-1
                    validaciones2.loc[48,'Observacion']="Error: No se indicó nota de 'Afectación por Ensanche' en Particularidades del formulario de Mensura"
            else:
                validaciones2.loc[48,'Resultado']=99
                validaciones2.loc[48,'Observacion']="Ok: No corresponde validar nota 'Afectación por Ensanche'"
            ...
            if "Linea de Edificacion Particularizada" in cur_afectaciones:
                if "Linea de Edificacion Particularizada" in particularidades:
                    if "Linea de Edificacion Particularizada".lower().replace(" ","") in (notas_0[0].lower()):
                        ...
                        validaciones2.loc[49,'Observacion']="Ok: Se indicó nota de 'Afectación por Linea de Edificacion Particularizada' en Notas del formulario de Mensura"
                    else:
                    ...
                    validaciones2.loc[49,'Resultado']=-1
                    validaciones2.loc[49,'Observacion']="Error: No se indicó nota de 'Afectación por Linea de Edificacion Particularizada' en Particularidades del formulario de Mensura"
            else:
                validaciones2.loc[49,'Resultado']=99
                validaciones2.loc[49,'Observacion']="Ok: No corresponde validar nota 'Afectación por Linea de Edificacion Particularizada'"       

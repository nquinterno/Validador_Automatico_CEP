...
def Abrir_Archivo_IFTAM():
    ...
    try:
        ...
        if last_dir != "":
            ...
            last_dir = os.path.abspath(documento)
      
        if documento.endswith(".pdf"):
            documento_1 = PyPDF2.PdfReader(documento)
...
##        Boton_Chequear_layers.grid_forget()
##        abrir_IFDOM.grid_forget()
##        abrir_IFFVN.grid_forget()
##        abrir_IFTAM.grid_forget()
##
##        btn_procesar_nuevo = Button(marco3,text="Procesar Cep Nuevo", command=procesar_nuevo)
##        btn_procesar_nuevo.configure(font=("Gotham Rounded",8))
##        btn_procesar_nuevo.grid(padx=5, pady=2, row = 0, column=0)
...
##                lados_parcelas_l.append(parcela.dxf.count)
 ...
 #valida que haya la misma cantidad de bloques de parcela insertos en el dxf que la cantidad de parcelas del layer parcelas
    ...
    for layer in layers_mejoras:
        ...
        band_form_dentro_0=list()
        band_form_dentro = list()
        
        form_0_mejora = list()
        form_1_mejora = list()
        form_muchos_mejora = list()
        ...
        #     info_form_0 = list()
        #     info_form_emp0 = list()
        #     info_form_nuevo0 = list()
        #     info_form_desc0 = list() 
        ...
        #         else:
        #             pass
        #     list_mejora_form = list()
        #     list_area_mejora = list()
        #     vertice_i = form.dxf.insert #coordenada de la inserción del bloque para validar que caiga dentro de una mejora

        #     for mejora in mejora_piso: #reccorre poligonos de mejoras
        #         vertices_m1 = mejora.get_points('xy') #para cada mejora obtiene los vertices y los prepara para la función de control
        #         vertices_m2 = Vec2.list(vertices_m1)
                        
        #         if ezdxf.math.is_point_in_polygon_2d(vertice_i,vertices_m2,abs_tol=1e-3)==-1: #validación de vertices arroja -1 si cae fuera, 0 si cae en los limites y 1 si cae dentro
        #             pass
        #         else:
        #             list_mejora_form.append(mejora)
        #             # info_form_0.append("1")
        #             list_area_mejora.append(round(ezdxf.math.area(Vec2.list(mejora.get_points('xy'))),2))
                    
        #             #capturar supericie del poligono y asociarla con el formulario
            
            
        #     if len(list_mejora_form)==0:
        #         band_form_dentro.append('-1')
        #         form_0_mejora.append(form)

        #     elif len(list_mejora_form)==1:
        #         band_form_dentro.append('0')
        #         form_1_mejora.append(form)
        #         if form.dxf.name == "form" :
        #             info_form_nuevo0.append({"form":f"{form_tipo}/{form_numero}","polig":f"{form_polig}","sup":f"{list_area_mejora[0]}"})
        #         elif form.dxf.name == "form_empadronado":
        #             info_form_emp0.append(list_area_mejora[0])
        #         elif form.dxf.name == "form_descubierto":
        #             info_form_desc0.append(list_area_mejora[0])
        #         else:
        #             pass

        #     elif len(list_mejora_form)>1:
        #         band_form_dentro.append('-2')
        #         form_muchos_mejora.append(form)
        #         #codigo que recorra de la lista de mejoras de ese piso y se fije que esa mejora tenga adentro un unico formulario de los que se repetian.
        #         for i in range (len(list_mejora_form)):
        #             list_mejora_comp = list_mejora_form[:]
        #             list_mejora_comp.pop(i)
        #             ## del list_mejora_comp[i]

        #             vertices_me0 = list_mejora_form[i].get_points('xy') #para cada mejora obtiene los vertices y los prepara para la función de control
        #             vertices_me1 = Vec2.list(vertices_me0)

        #             mejora_adentro =list ()
        #             band_mej_mej_dentro = list()
        #             for mejora in list_mejora_comp:
        #                 vertices_me2 = mejora.get_points('xy') #para cada mejora obtiene los vertices y los prepara para la función de control
        #                 vertices_me3 = Vec2.list(vertices_me2)
                        
        #                 band_vert_mej_dentro = list()
                        
        #                 for vertice in vertices_me3:
        #                     if ezdxf.math.is_point_in_polygon_2d(vertice,vertices_me1,abs_tol=1e-3)==-1: #validación de vertices arroja -1 si cae fuera, 0 si cae en los limites y 1 si cae dentro
        #                         band_vert_mej_dentro.append("-1")
        #                     else:
        #                         band_vert_mej_dentro.append("0")
                        
        #                 if "-1" in band_vert_mej_dentro:
        #                     band_mej_mej_dentro.append("-1")
        #                 else:
        #                     band_mej_mej_dentro.append("0")
        #                     mejora_adentro.append(mejora)
                    
        #             sup_mejora_dentro = 0
                   
        #             for mejora in mejora_adentro:
        #                 sup_mejora_dentro = sup_mejora_dentro + round(ezdxf.math.area(Vec2.list(mejora.get_points('xy'))),2)
                    
        #             sup_mejora_descont = round(ezdxf.math.area(Vec2.list(list_mejora_form[i].get_points('xy'))),2) - sup_mejora_dentro

        #             if form.dxf.name == "form" :
        #                 info_form_nuevo0.append({"form":f"{form_tipo}/{form_numero}","polig":f"{form_polig}","sup":f"{sup_mejora_descont}"})
        #             elif form.dxf.name == "form_empadronado":
        #                 info_form_emp0.append(sup_mejora_descont)
        #             elif form.dxf.name == "form_descubierto":
        #                 info_form_desc0.append(sup_mejora_descont)
        #             else:
        #                 pass
        #         #de las mejoras de la lista detectar si una esta dentro de otra y cual es la mas chica, la mas chica de las dos es la que estar asociada al form.
                 
        #     # if len (info_form_0)>1:
        #     #     band_form_dentro.append('-2')
                

        #     # elif len (info_form_0)==1:

        #     #     band_form_dentro.append('0')

        #     #     if len (info_form_nuevo0):
        #     #         info_form_nuevo.append(info_form_nuevo0[0]) #crean una lista donde van toda la info de los formularios nuevos
        #     #     elif len (info_form_emp0):
        #     #         info_form_emp.append(info_form_emp0[0]) #crean una lista donde la superficie de los firm empadronados
        #     #     else:
        #     #         pass
                
        #     # elif len (info_form_0)==0:
        #     #     band_form_dentro.append('-1')
        ...
        for i in range (len(mejora_piso)):
            ...
            # if "0" in band_mej_mej_dentro_2:
            #     pass
            # else:
            #     vertices_mf1 = mejora_piso[i].get_points('xy') #para cada mejora obtiene los vertices y los prepara para la función de control
            #     vertices_mf2 = Vec2.list(vertices_mf1)
                
            #     for form in form_piso:
            #         vertice_if = form.dxf.insert #coordenada de la inserción del bloque para validar que caiga dentro de una mejora
            #         if ezdxf.math.is_point_in_polygon_2d(vertice_if,vertices_mf2,abs_tol=1e-3)==-1: #validación de vertices arroja -1 si cae fuera, 0 si cae en los limites y 1 si cae dentro
            #             pass
            #         else:
            #             pass
            ...
            sup_mejora_dentro_2 = 0
            if len(mejora_adentro_2):
                ...
                for mejora in mejora_adentro_2:
                    if mejora.has_arc: ##Calcula la superficie de cada poligono que esta dentro del poligono madre dependiendo si tiene arco o no la polilinea
                        mejora_explode = mejora.virtual_entities()
                        for entity in mejora_explode:

                            if entity.dxftype() == "ARC":
                                entity_0.append(entity.flattening(0.00000001))

                                for ent in entity_0:
                                    points = list(ent)
                                    for p in points:  
                                        entity_2.append((p.x, p.y))
                            else:
                                entity_2.append((entity.dxf.start.x, entity.dxf.start.y))

                        ##sup_mejora_dentro_2 = sup_mejora_dentro_2 + round(ezdxf.math.area(Vec2.list(mejora.get_points('xy'))),2)
                        sup_mejora_dentro_2 = sup_mejora_dentro_2 + round(ezdxf.math.area(Vec2(punto) for punto in entity_2),2)
                    else:
                        sup_mejora_dentro_2 = sup_mejora_dentro_2 + round(ezdxf.math.area(Vec2.list(mejora.get_points('xy'))),2)
                
                sup_mejora_descont_2 = sup_mejora_0 - sup_mejora_dentro_2
                
                if len(form_dentro_mejora_2):
                    ...
                    for form1 in form_dentro_mejora_2:
                        ...
                        if "-1" in band_form_polig_dentro:
                            ...
                            form_dentro_mejora.append(form1)
                    
                    if len(form_dentro_mejora) == 1:
                        if form_dentro_mejora[0].dxf.name == "form" :
                            
                            for attrib in form_dentro_mejora[0].attribs:
                                if attrib.dxf.tag=="Nº_POLIG.":
                                    if len(attrib.dxf.text)==0:
                                        band_form_polig.append('-1')
                                    else:
            ...
            print(f"mejora_piso[{i}]")
            print(round(ezdxf.math.area(Vec2.list(mejora_piso[i].get_points('xy'))),2))

            print("sup_mejora_dentro")
            print(sup_mejora_dentro_2)

            print("sup_mejora_descont_2")
            print(sup_mejora_descont_2)
    ...
    print ("sup. cubierta real")
    print(sup_cub_dxf)
    print(sum(sup_cub_dxf))
    print ("sup. semicubierta real")
    print(sup_semicub_dxf)
    print(sum(sup_semicub_dxf))
    print ("sup. descubierta real")
    print(sup_descub_dxf)
    print(sum(sup_descub_dxf))
    print ("sup. a descontar real")
    print(sup_descont_dxf)
    print(sum(sup_descont_dxf))
    
    print ("sup. empadronada real")
    print(info_form_emp)
    print(sum(info_form_emp))

    print("Sup a empadronar real")
    print(info_form_nuevo)
    print(sum(info_form_nuevo))

    print("Sup desc bloque real")
    print(info_form_desc)
    print(sum(info_form_desc))

    
    print("Sup poligonos sin bloque agip")
    print(info_form_sin_info)
    print(sum(info_form_sin_info))

    print("Sup poligonos mas de un bloque agip")
    print(info_form_muchos_form)
    print(sum(info_form_muchos_form))
    ...
    if len(mejoras): #si hay entindades en el layer mejoras comienza la validacion de las mismas sino arroja error que no hay nada en ese layer
        ...
        validaciones2.loc[19,'Observacion']="Error: si se trata de un baldío debe dibujar un poligono 'descubierto'"
        validaciones2.loc[19,'Cetegoría']='Mejoras'

        validaciones2.loc[20,'Resultado']=-1 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[20,'Observacion']="Error: si se trata de un baldío debe dibujar un poligono 'descubierto'"
        validaciones2.loc[20,'Cetegoría']='Mejoras'

        validaciones2.loc[21,'Resultado']=-1 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[21,'Observacion']="Error: si se trata de un baldío debe dibujar un poligono 'descubierto'"
        validaciones2.loc[21,'Cetegoría']='Mejoras'

        validaciones2.loc[22,'Resultado']=-1 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[22,'Observacion']="Error: si se trata de un baldío debe dibujar un poligono 'descubierto'"
        validaciones2.loc[22,'Cetegoría']='Mejoras'
    ...
    restriciones = doc.modelspace().query('*[layer=="RESTRICCIONES"]')
                ...
                if "-1" in band_tol_m:
                    ...
                    if "-1" in band_tol_p:
                        ...
                        if dif_max > 0.50:
                            ...
                            validaciones2.loc[32,'Resultado']=50 # si hay un -1 en la bandera arroja error 
                            validaciones2.loc[32,'Observacion']="Verificar: La parcela medida excede la tolerancia admitida respecto a la parcela antecedente (0.5m)"
                            validaciones2.loc[32,'Cetegoría']='Tolerancias'
...
def resumen():
    ...
    if(len(mejoras_poly)): #suma la superficie cubierta, semicubierta y descubieta (contempla balcones) del dxf
        for mejora in mejoras_poly:
            entity_2 = list()
            entity_0 = list()

            # si la mejora posee un arco tiene que explotar la polilinea aproximar el arco a travez de rectas con el comando flattening() y luego generar el vec2 para calcular la sup
            if mejora.has_arc:
                mejora_explode = mejora.virtual_entities()
                for entity in mejora_explode:
                    if entity.dxftype() == "ARC":
                        ...
                        for ent in entity_0:
                            ...
                            # Obtener las coordenadas "x" e "y" de cada punto y almacenarlas en una lista de tuplas
                            for p in points:
                ...
                if mejora.dxf.color == 1 or mejora.dxf.color == 200 or mejora.dxf.color == 220:
                    cubierta_dxf_0 = cubierta_dxf_0 + ezdxf.math.area(Vec2(punto) for punto in entity_2)
                elif mejora.dxf.color == 2 or mejora.dxf.color == 4:
                    semicubierta_dxf_0 = semicubierta_dxf_0 + ezdxf.math.area(Vec2(punto) for punto in entity_2)
                elif mejora.dxf.color == 3 or mejora.dxf.color == 5:
                    descubierta_dxf_0 = descubierta_dxf_0 + ezdxf.math.area(Vec2(punto) for punto in entity_2)
                else:
                    pass

            else:
                if mejora.dxf.color == 1 or mejora.dxf.color == 200 or mejora.dxf.color == 220:
                    cubierta_dxf_0 = cubierta_dxf_0 + ezdxf.math.area(Vec2.list(mejora.get_points('xy')))
                elif mejora.dxf.color == 2 or mejora.dxf.color == 4:
                    semicubierta_dxf_0 = semicubierta_dxf_0 + ezdxf.math.area(Vec2.list(mejora.get_points('xy')))
                elif mejora.dxf.color == 3 or mejora.dxf.color == 5:
                    descubierta_dxf_0 = descubierta_dxf_0 + ezdxf.math.area(Vec2.list(mejora.get_points('xy')))
                else:
                    pass
    ...
    descubierta_dxf = round(descubierta_dxf_0,2)
    semicubierta_dxf = round(semicubierta_dxf_0,2)
    cubierta_dxf = round(cubierta_dxf_0,2)
...
##        dif_cubierta_dxf = round(cubierta_dxf,0) - round(cubierta_3,0)
##        dif_semi_dxf = round(semicubierta_dxf,0) - round(semi_3,0)
##        dif_desc_dxf = round(descubierta_dxf,0) - round(des_3,0)

        sup_cub_dxf_0 = sum(sup_cub_dxf)
        sup_semicub_dxf_0 = sum(sup_semicub_dxf) 
        sup_descub_dxf_0 = sum(sup_descub_dxf)
        ...
        nota_cont = "Del cotejo con el plano de obra civil registrado que se tuvo a la vista al momento de la constitución, surge que existen construcciones en contravención que no se convalidan y deberán ser demolidas o en su defecto regularizadas con la presentación del respectivo plano de obra civil"

    
        nota_exce_1 = "De la presente Constitución de Estado Parcelario surge una diferencia de superficie entre título y parcela que supera las tolerancias del Art. 23 de la Ley N° 643734, se deberá realizar mensura para determinar la ubicación del polígono de excedente o realizar el saneo de título previo a realizar cualquier trámite de obra sobre dicho sector"
        
        nota_exce_2_1 ="Existe excedente según mensura"
        nota_exce_2_2 =" el que se deberá regularizar previo a realizar cualquier trámite de obra sobre dicho sector"

        nota_agip_nodif = "La superficie edificada citada en el presente certificado se encuentra empadronada a la fecha de mensura"
        
        nota_agip_dif_mas = "Del cotejo con el certificado de empadronamiento surge que existen construcciones no empadronadas para las cuales la Agencia Gubernamental de Ingresos Públicos calculará el Valor Fiscal Homogéneo en base al relevamiento efectuado. Salvo acuerdo de partes en contrario, la deuda que pudiera generarse por las edificaciones no empadronadas serán imputadas al transmitente"
        
        nota_agip_dif_menos = "Del cotejo con certificado de empadronamiento que se tuvo a la vista al momento de la constitución, surge que existen construccines que han sido dadas de baja. La Agencia Gubernamental de INgresos Públicos calculará el Valor fiscal Homogeno de la parcela en base al relevamiento efectuado"
        
        nota_agip_baldio = "El Certificado de Empadronamiento emitido por AGIP para la parcela no cita superficie del edificio a la fecha de mensura" 
        ...
        if cont_3 > 0:
            ...
            if ((nota_cont.lower()).replace(" ","")) in ((notas_0[0]).lower()):
        ...
        if (mensura_3 - sup_tit) >0:
            if (mensura_3 - sup_tit) > (0.05 * mensura_3):
                if ((nota_exce_1.lower().replace(" ","")) in notas_0[0].lower()) or (((nota_exce_2_1.lower().replace(" ","")) in (notas_0[0].lower())) and ((nota_exce_2_2.lower().replace(" ","")) in (notas_0[0].lower()))):
                    validaciones2.loc[41,'Resultado']=0
                    validaciones2.loc[41,'Observacion']="Ok: Se ha detectado alguna de las notas de Excedente d elos RT en el campo 'Notas' del formulario tecnico de Mensura"
                else:
                    validaciones2.loc[41,'Resultado']=-1
                    validaciones2.loc[41,'Observacion']="Error: No se ha detectado alguna de las notas de Excedente d elos RT en el campo 'Notas' del formulario tecnico de Mensura"
            else:
        ...
        if "excedente" in (particularidades[0].lower().replace(" ","")):
            if (nota_exce_1.lower().replace(" ","")) in notas_0[0].lower():
        ...
        if dif_agip =="no":
            if (nota_agip_nodif.lower()) in (notas_0[0].lower()):
            ...
            if len(agip_supnueva)>0:
                if (nota_agip_dif_mas.lower().replace(" ","")) in (notas_0[0].lower()):
                    validaciones2.loc[43,'Resultado']=0
                    validaciones2.loc[43,'Observacion']="Ok: se declaró que difiere con agip, superficie nueva y se detectó la nota correspondiente segun los RT en el campo notas del form. tecnico de mensura"
                else:
                    validaciones2.loc[43,'Resultado']=-1
                    validaciones2.loc[43,'Observacion']="Error: se declaró que difiere con agip, superficie nueva y no se detectó la nota correspondiente segun los RT en el campo notas del form. tecnico de mensura"
            else:
                if (nota_agip_dif_menos.lower().replace(" ","")) in (notas_0[0].lower()):
                    validaciones2.loc[43,'Resultado']=0
                    validaciones2.loc[43,'Observacion']="Ok: se declaró que difiere con agip, sin superficie nueva y se detectó la nota correspondiente segun los RT en el campo notas del form. tecnico de mensura"
                else:
                    validaciones2.loc[43,'Resultado']=-1
                    validaciones2.loc[43,'Observacion']="Error: se declaró que difiere con agip, sin superficie nueva y no se detectó nota correspondiente según los RT en el campo notas del form. técnico de mensura"
        else:
            validaciones2.loc[43,'Resultado']=-1
...
def salida_pdf():
    ...
    if len(validaciones3)>0:
        ...
        for index, row in validaciones3.iterrows():
            ...
            #inserta el texto
            c.drawString(20, i, str(row['N°']))
            c.drawString(50, i, row['Observacion'])
            i-=20

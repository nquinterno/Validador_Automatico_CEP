...
from shapely import Polygon, union, difference, area, geometry, Point, get_num_coordinates
from os import path
    ...
    for layer in layers_mejoras:
        ...
        for i in range (len(mejora_piso)):
            ...
            for mejora in mejora_piso_comp:
                vertices_mp2 = list()
                for vert in mejora.vertices():
                    if vert in vertices_mp2:
                        pass
                    else:
                        vertices_mp2.append(vert)
            ...
            if len(mejora_adentro_2)>0:
                vertices_mp4 = list()
                for vert in mejora_adentro_2[0].vertices():
                    if vert in vertices_mp4:
                        pass
                    else:
                        vertices_mp4.append(vert)
                ...
                poligono_madre = Polygon(vertices_mp0)
                print("numero de vertices")
                print(get_num_coordinates(poligono_madre))
                ...
                poligono_agujero = Polygon(vertices_mp4)
                for mejora in mejora_adentro_2:

                    vertices_md0 = list()
                    for vert in mejora.vertices():
                        if vert in vertices_md0:
                            pass
                        else:
                            vertices_md0.append(vert)

                    #va uniendo los poligonos de las mejoras hijas
                    mejora_poligon = Polygon(vertices_md0)
                    print("mejora_poligon")
                    print(area(mejora_poligon))
                    print("numero de vertices")
                    print(get_num_coordinates(mejora_poligon))
                ...
                print("poligono_madre")
                print(area(poligono_madre))
                print("area poligono_agujero")
                print(area(poligono_agujero))
                print("numero de vertices")
                print(get_num_coordinates(poligono_agujero))

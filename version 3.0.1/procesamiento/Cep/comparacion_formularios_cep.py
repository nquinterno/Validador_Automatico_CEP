...
def resumen(smp, pages_IFTAM_text, pages_IFFVN_text, pages_IFDOM_text,pages_FOMUBI_text,parcelas_poly,excedentes_poly,piso_con_mejoras, info_form_emp,info_form_nuevo,exp_layout, band_parc_arc, medidas_dxf, sup_cub_dxf, sup_semicub_dxf, sup_descub_dxf, sup_descont_dxf, band_mejora_cub_arc_0, band_mejora_semi_arc_0, band_mejora_desc_arc_0, band_mejora_emp_arc_0, band_mejora_nueva_arc_0, nom_parc_list, resultado_inv):
    ...
    if len(pages_IFTAM_text)>0 and len(pages_IFFVN_text)>0 and len(pages_IFDOM_text)>0 and len(pages_FOMUBI_text)>0:
        ...
        # print("resultado inv", resultado_inv)
        # if resultado_inv == "ok":
            
        #     validaciones_comparacion.loc[14,'Resultado'] = 0
        #     validaciones_comparacion.loc[14,'Observacion']="Ok: No se detectarón construcciones en el model invadiendo via pública o linderos"

        #     validaciones_comparacion.loc[15,'Resultado'] = 0
        #     validaciones_comparacion.loc[15,'Observacion']="Ok: No se detectarón construcciones en el model invadiendo via pública o linderos"
        ...
        #         validaciones_comparacion.loc[14,'Resultado']=0
        #         validaciones_comparacion.loc[14,'Observacion']="Ok: Existen construcciones fuera de la manzana y se indicó nota de invasion a via publica"

        #         validaciones_comparacion.loc[15,'Resultado']=0
        #         validaciones_comparacion.loc[15,'Observacion']="Ok: Existen construcciones fuera de la manzana y se indicó nota de invasion a via publica"
            
        #     else:
                
        #         validaciones_comparacion.loc[14,'Resultado']=-1
        #         validaciones_comparacion.loc[14,'Observacion']="Error: Existen construcciones fuera de la manzana y NO se indicó nota de invasion a via publica"

        #         validaciones_comparacion.loc[15,'Resultado']=-1
        #         validaciones_comparacion.loc[15,'Observacion']="Error: Existen construcciones fuera de la manzana y NO se indicó nota de invasion a via publica"
        ...
        #         validaciones_comparacion.loc[14,'Resultado']=0
        #         validaciones_comparacion.loc[14,'Observacion']="Ok: Se indicó nota de construcciones encaballadas y se encuntran representadas en el model construcciones encaballadas con otra parcela"

        #         validaciones_comparacion.loc[15,'Resultado']=0
        #         validaciones_comparacion.loc[15,'Observacion']="Ok: Se indicó nota de construcciones encaballadas y se encuntran representadas en el model construcciones encaballadas con otra parcela" 
            
        #     else:
                
        #         validaciones_comparacion.loc[14,'Resultado']=-1
        #         validaciones_comparacion.loc[14,'Observacion']="Error: Se encuntran representadas en el model construcciones encaballadas con otra parcela y NO se indicó la nota correspondiente"

        #         validaciones_comparacion.loc[15,'Resultado']=-1
        #         validaciones_comparacion.loc[15,'Observacion']="Error: Se encuntran representadas en el model construcciones encaballadas con otra parcela y NO se indicó la nota correspondiente"
        ...
        #         validaciones_comparacion.loc[14,'Resultado']=0
        #         validaciones_comparacion.loc[14,'Observacion']="Ok: Existen construcciones fuera de la manzana en el model y se indicó nota de invasion a via publica"
            
        #     else:
                
        #         validaciones_comparacion.loc[14,'Resultado']=-1
        #         validaciones_comparacion.loc[14,'Observacion']="Error: Existen construcciones fuera de la manzana en el model y NO se indicó nota de invasion a via publica"

        #     if "const_encaballada" in band_notas:
                
        #         validaciones_comparacion.loc[15,'Resultado']=0
        #         validaciones_comparacion.loc[15,'Observacion']="Ok: Existen construcciones dibujadas sobre otra parcela en el model y se indicó nota de construcciones encaballadas"
        #     else:
                
        #         validaciones_comparacion.loc[15,'Resultado']=-1
        #         validaciones_comparacion.loc[15,'Observacion']="Error: Existen construcciones dibujadas sobre otra parcela en el model y No se indicó nota de construcciones encaballadas"
        ...
        if "-1" in band_cur_parcela:
            ...
            if "Cinturon Digital" in cur_afectaciones:
                if "cinturón digital" in particularidades.lower() or "cinturon digital" in particularidades.lower():
            ...
            if "Afectación por Apertura" in cur_afectaciones:
                if "afectación por apertura" in particularidades.lower() or "afectacion por apertura" in particularidades.lower():
                    ...
                    if "apertura" in band_notas:  
                        ...
                        validaciones_comparacion.loc[18,'Observacion']="Ok: Se indicó nota de 'Afectación por Apertura' en Notas del formulario de Mensura"
                    else:
                        validaciones_comparacion.loc[18,'Resultado']=-1
                        validaciones_comparacion.loc[18,'Observacion']="Error: No se indicó nota de 'Afectación por Apertura' en Notas del formulario de Mensura"
                else:
                    validaciones_comparacion.loc[18,'Resultado']=-1
                    validaciones_comparacion.loc[18,'Observacion']="Error: No se indicó nota de 'Afectación por Apertura' en Particularidades del formulario de Mensura"
            else:
                validaciones_comparacion.loc[18,'Resultado']=99
                validaciones_comparacion.loc[18,'Observacion']="Ok: No corresponde validar nota 'Afectación por Apertura'"
            ...
            if "Linea de Edificacion Particularizada" in cur_afectaciones:
                if "linea de edificación particularizada" in particularidades.lower() or "linea de edificacion particularizada" in particularidades.lower():

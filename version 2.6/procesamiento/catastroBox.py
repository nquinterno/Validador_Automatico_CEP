...
def rumbo(parcela, seg):
    ...
    if seg.dxftype()== "ARC":
        ...
        offset_seg_1 = list(ezdxf.math.offset_vertices_2d(vert_offset,offset=0.05, closed=False)) 
        offset_seg_2 = list(ezdxf.math.offset_vertices_2d(vert_offset,offset=-0.05, closed=False)) 
